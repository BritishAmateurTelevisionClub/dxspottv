...
$('#listen_70cm_box').change(function() {
	if ($('#listen_70cm_box').is(":checked")) {
		$('#listen_70cm_options').show("fast");
	} else {
		$('#listen_70cm_options').hide("fast");
	}
});
$('#listen_23cm_box').change(function() {
	if ($('#listen_23cm_box').is(":checked")) {
		$('#listen_23cm_options').show("fast");
	} else {
		$('#listen_23cm_options').hide("fast");
	}
});
$('#listen_13cm_box').change(function() {
	if ($('#listen_13cm_box').is(":checked")) {
		$('#listen_13cm_options').show("fast");
	} else {
		$('#listen_13cm_options').hide("fast");
	}
});
